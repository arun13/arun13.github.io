...
function format_data_icu_bar(tobeformatdata) {
...
function initChartIcuBar(rawdata,svg) {
    var counry_data = rawdata.filter(function (d) {
        return d.location == "India";
    });
    var formatted_data = format_data_icu_bar(counry_data);
...
function updateChartIcuBar(country, rawdata,svg) {
    var counry_data = rawdata.filter(function (d) {
...
function icuCasesBar(svg,country) {
